...
public class Sign {
    public static void main(String[] args) {
        ...
        Sign sign = new Sign();
        /*try {
            JSONObject json = sign.sign(corpid, corpsecret, url);
    ...
    public JSONObject sign(String token, String url) throws IOException {
        ...
        String jsapi_ticket = sw.getJssdkTicket(token);
