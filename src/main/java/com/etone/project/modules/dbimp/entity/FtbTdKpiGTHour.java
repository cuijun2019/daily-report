 ...
 */
@ImportTable(tableName = "ftbTdKpi_GT_hour")
public class FtbTdKpiGTHour {
    ...
    @Meta(name = "忙时PS域拥塞率(%)")
    @ImportEntity(importName = "忙时PS域拥塞率(%)", convertRugular="%:,/0:,#DIV/0!:")
    private Double dbCongestionRate;
    
    @Meta(name = "忙时PS域RAB拥塞率(%)")
    @ImportEntity(importName = "忙时PS域RAB拥塞率(%)", convertRugular="%:,/0:,#DIV/0!:")
    private Double dbABCongestionRate;
    
    @Meta(name = "忙时小区码资源利用率(%)")
    @ImportEntity(importName = "忙时小区码资源利用率(%)", convertRugular="%:,/0:,#DIV/0!:")
