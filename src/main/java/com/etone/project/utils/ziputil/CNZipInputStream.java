 ...
 */
public
class CNZipInputStream extends InflaterInputStream implements ZipConstants {
...
//            Logger.getLogger(this.getClass()).error("getNextEntry.readLOC" + exception.getMessage());
            return null;
        }
