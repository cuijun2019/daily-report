 ...
 */
public class SetValueToEntity03 implements SetValueToEntity {
    
    private String getValue(Object cell, Map<String, String> regularMap) {
        String value = POIExcelCompatible.get03CellForString(cell);
    ...
    public void setboolean(Method method, Object cell, Object entity, Map<String, String> regularMap) {
        try {
            ...
            Logger.getLogger(SetValueToEntity03.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void setDate(Method method, Object cell, Object entity, Map<String, String> regularMap) {
        try {
            Date date = POIExcelCompatible.get03DateCellValue(cell);
            if (date != null) {
