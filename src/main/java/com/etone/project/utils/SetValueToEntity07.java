 ...
 */
public class SetValueToEntity07 implements SetValueToEntity {
    
    private String getValue(Object cell, Map<String, String> regularMap) {
        String value = POIExcelCompatible.get07CellForString(cell);
    ...
    public void setboolean(Method method, Object cell, Object entity, Map<String, String> regularMap) {
        try {
            ...
            Logger.getLogger(SetValueToEntity07.class.getName()).log(Level.SEVERE, ex.getMessage());
        }
    }
    ...
    public void setLong(Method method, Object cell, Object entity, Map<String, String> regularMap) {
        try {
            ...
            Logger.getLogger(SetValueToEntity07.class.getName()).log(Level.SEVERE, (ex.getMessage() + ", value = " + this.getValue(cell, regularMap) + ", method:" + method.getName()));
        }
    }
    ...
    public void setDate(Method method, Object cell, Object entity, Map<String, String> regularMap) {
        try {
            Date date = POIExcelCompatible.get07DateCellValue(cell);
            if (date != null) {
