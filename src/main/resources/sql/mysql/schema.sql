...
MySQL - 5.1.54-community : Database - eoms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pmcx` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `tbAttachment` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `vcFileName` varchar(200) DEFAULT NULL,
  `vcFileType` varchar(10) DEFAULT NULL,
  `bigFileSize` bigint(20) DEFAULT NULL,
  `vcPath` varchar(400) DEFAULT NULL,
  `vcOuPath` varchar(1000) DEFAULT NULL,
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
  `dtModifyTime` timestamp NULL DEFAULT NULL,
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
)ENGINE=InnoDB DEFAULT CHARSET=utf8 CHECKSUM=1;

/*Table structure for table `tbPlanet` */

DROP TABLE IF EXISTS `tbPlanet`;

CREATE TABLE `tbPlanet` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigParentId` bigint(20) NOT NULL,
  `vcKind` varchar(10) DEFAULT NULL,
  `vcCode` varchar(50) DEFAULT NULL,
  `vcName` varchar(200) DEFAULT NULL,
  `isLeaf` tinyint(1) DEFAULT '0',
  `intLevel` int(11) DEFAULT '0',  
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
  `dtModifyTime` timestamp NULL DEFAULT NULL,
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
  KEY `FK_REF_PROVINCE_CITY` (`bigParentId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 CHECKSUM=1;
...
/*Table structure for table `tbOrganization` */

DROP TABLE IF EXISTS `tbOrganization`;

CREATE TABLE `tbOrganization` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigParentId` bigint(20) DEFAULT NULL,
  `vcOuguid` varchar(50) DEFAULT NULL,
  `vcParentOuguid` varchar(50) DEFAULT NULL,
  `intOuKind` smallint(6) DEFAULT NULL,
  `vcOuName` varchar(100) DEFAULT NULL,
  `vcParentName` varchar(200) DEFAULT NULL,
  `intLevel` int(11) DEFAULT '0',
  `isLeaf` tinyint(1) DEFAULT '0',
...
/*Data for the table `tbOrganization` */
...
CREATE TABLE `tbEmployee` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigOrganizationId` bigint(20) NOT NULL,
  `vcCompany` varchar(200) DEFAULT NULL,
  `vcCompanyGuid` varchar(50) DEFAULT NULL,
  `vcDepartment` varchar(50) DEFAULT NULL,
  `vcDepartmentGuid` varchar(50) DEFAULT NULL,
  `vcStaffGuid` varchar(50) DEFAULT NULL,
  `vcFullName` varchar(100) DEFAULT NULL,
  `vcStaffNo` varchar(20) DEFAULT NULL,
  `vcWorkphone` varchar(50) DEFAULT NULL,
  `vcTelephone` varchar(50) DEFAULT NULL,
  `vcShortMobile` varchar(10) DEFAULT NULL,
  `vcSex` varchar(4) DEFAULT NULL,
  `vcTitle` varchar(50) DEFAULT NULL,
  `vcEmail` varchar(128) DEFAULT NULL,
  `vcAddress` varchar(200) DEFAULT NULL,
  `vcPosition` varchar(50) DEFAULT NULL,
  `dtBrithday` timestamp NULL DEFAULT NULL,
  `dtHireDate` timestamp NULL DEFAULT NULL,
  `dtFireDate` timestamp NULL DEFAULT NULL,
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
  KEY `FK_REF_ORGANIZATION_EMPLOYEE` (`bigOrganizationId`),
  CONSTRAINT `FK_REF_ORGANIZATION_EMPLOYEE` FOREIGN KEY (`bigOrganizationId`) REFERENCES `tbOrganization` (`bigId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 CHECKSUM=1;

/*Data for the table `tbEmployee` */
...
CREATE TABLE `tbOperateLog`(
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `intYear` int(11) DEFAULT NULL,
  `intMonth` int(11) DEFAULT NULL,
  `intDay` int(11) DEFAULT NULL,
  `intHour` int(11) DEFAULT NULL,
  `vcIpv4` varchar(20) DEFAULT NULL,
  `vcIpv6` varchar(20) DEFAULT NULL,
  `vcAccount` varchar(50) DEFAULT NULL,
  `vcSystemCode` varchar(100) DEFAULT NULL,
  `vcSystem` varchar(100) DEFAULT NULL,
  `vcModuleCode` varchar(100) DEFAULT NULL,
  `vcModule` varchar(100) DEFAULT NULL,
  `dtStartLogTime` timestamp NULL DEFAULT NULL,
  `dtEndLogTime` timestamp NULL DEFAULT NULL,
  `intRespCost` int(11) DEFAULT NULL,
  `intQueryCost` int(11) DEFAULT NULL,
  `intRespRecord` int(11) DEFAULT NULL,
  `vcResultCode` varchar(20) DEFAULT NULL,
  `intLogLevel` int(11) DEFAULT NULL,
  `vcLogLevelName` varchar(20) DEFAULT NULL,
  `intLogType` int(11) DEFAULT NULL,
  `vcLogTypeName` varchar(20) DEFAULT NULL,
  `intStatus` int(11) DEFAULT NULL COMMENT '实施中,结项',
  `vcContent` varchar(5000) DEFAULT NULL,
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=179 DEFAULT CHARSET=utf8 CHECKSUM=1;
...
/*Table structure for table `tbPrivilege` */

DROP TABLE IF EXISTS `tbPrivilege`;

CREATE TABLE `tbPrivilege` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigParentId` bigint(20) DEFAULT NULL,
  `vcKind` varchar(10) DEFAULT NULL COMMENT '对应数据字典：USER_TYPE\r\n            组织：USER_TYPE_ORGANIZATION\r\n            本地：USER_TYPE_LOCAL',
  `vcName` varchar(200) DEFAULT NULL,
  `vcCode` varchar(12) DEFAULT NULL COMMENT '权限编码',
  `vcSymbol` varchar(200) DEFAULT NULL,
  `vcPath` varchar(1000) DEFAULT NULL,
  `vcUrl` varchar(1000) DEFAULT NULL,
  `isLeaf` tinyint(1) DEFAULT '0',
  `intLevel` int(11) DEFAULT '0',
  `intOrder` int(11) DEFAULT NULL,
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 CHECKSUM=1;

/*Data for the table `tbPrivilege` */
...
/*Table structure for table `tbBaseta` */

DROP TABLE IF EXISTS `tbBaseta`;

CREATE TABLE `tbBaseta` (
  `bigId` BIGINT(20) DEFAULT NULL,
  `bigParentId` BIGINT(20) DEFAULT NULL,
  `vcKind` VARCHAR(20) DEFAULT NULL,
  `vcCatalog` VARCHAR(200) DEFAULT NULL,
  `vcName` VARCHAR(200) DEFAULT NULL,
  `vcSchema` VARCHAR(200) DEFAULT NULL,
  `vcTableName` VARCHAR(200) DEFAULT NULL,
  `vcFieldName` VARCHAR(200) DEFAULT NULL,
  `vcPropertyName` VARCHAR(200) DEFAULT NULL,
  `intWidth` INT(11) DEFAULT NULL,
  `isHidden` TINYINT(4) DEFAULT NULL,
  `isExportable` TINYINT(4) DEFAULT NULL,
...
/*Table structure for table `tbUita` */

DROP TABLE IF EXISTS `tbUita`;

CREATE TABLE `tbUita` (
  `bigId` BIGINT(20) DEFAULT NULL,
  `bigParentId` BIGINT(20) DEFAULT NULL,
  `bigPrivilegeId` BIGINT(20) DEFAULT NULL,
  `vcKind` VARCHAR(20) DEFAULT NULL,
  `vcCatalog` VARCHAR(200) DEFAULT NULL,
  `vcName` VARCHAR(200) DEFAULT NULL,
  `vcSchema` VARCHAR(200) DEFAULT NULL,
...
/*Table structure for table `tbRolePrivilege` */

DROP TABLE IF EXISTS `tbRolePrivilege`;

CREATE TABLE `tbRolePrivilege` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigPrivilegeId` bigint(20) NOT NULL,
  `bigRoleId` bigint(20) NOT NULL,
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
  KEY `FK_REF_PROVILEGE_ROLE` (`bigPrivilegeId`),
  KEY `FK_REF_ROLE_PROVILEGE` (`bigRoleId`),
  CONSTRAINT `FK_REF_PROVILEGE_ROLE` FOREIGN KEY (`bigPrivilegeId`) REFERENCES `tbPrivilege` (`bigId`),
  CONSTRAINT `FK_REF_ROLE_PROVILEGE` FOREIGN KEY (`bigRoleId`) REFERENCES `tbRole` (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 CHECKSUM=1;

/*Data for the table `tbRolePrivilege` */
...
/*Table structure for table `tbOrganizationRole` */

DROP TABLE IF EXISTS `tbOrganizationRole`;
...
CREATE TABLE `tbOrganizationRole` (
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
  KEY `FK_REF_ORGANIZATION_ROLE` (`bigOrganizationId`),
  KEY `FK_REF_ROLE_ORGANIZATION` (`bigRoleId`),
  CONSTRAINT `FK_REF_ORGANIZATION_ROLE` FOREIGN KEY (`bigOrganizationId`) REFERENCES `tbOrganization` (`bigId`),
  CONSTRAINT `FK_REF_ROLE_ORGANIZATION` FOREIGN KEY (`bigRoleId`) REFERENCES `tbRole` (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 CHECKSUM=1;
...
CREATE TABLE `tbSystemLog` (
  `bigId` int(11) NOT NULL AUTO_INCREMENT,
  `vcIpv4` varchar(20) DEFAULT NULL,
  `vcIpv6` varchar(20) DEFAULT NULL,
  `vcAccount` varchar(50) DEFAULT NULL,
  `vcSystemCode` varchar(100) DEFAULT NULL,
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 CHECKSUM=1 COMMENT='记录系统登录及异常信息';
...
CREATE TABLE `tbUser` (
  ...
  `vcOuguid` varchar(50) DEFAULT NULL,
  `vcOuName` varchar(100) DEFAULT NULL,
  `vcAccount` varchar(50) NOT NULL,
  `vcPassword` varchar(64) DEFAULT NULL COMMENT '支持存储MD5,SHA-1,SHA-256',
  `vcSalt` VARCHAR(64) DEFAULT NULL COMMENT '随机强密码序列，基于base-64编码，用于密码加密验证',
  `vcTips` varchar(100) DEFAULT NULL,
  `vcTipAnswer` varchar(200) DEFAULT NULL,
  `vcKind` varchar(10) DEFAULT NULL COMMENT '对应数据字典：USER_TYPE\r\n            组织：USER_TYPE_ORGANIZATION\r\n            本地：USER_TYPE_LOCAL',
  `vcFullName` varchar(100) DEFAULT NULL,
  `vcSex` varchar(4) DEFAULT NULL,
  `vcWorkphone` varchar(50) DEFAULT NULL,
  ...
  `dtLockedDate` timestamp NULL DEFAULT NULL COMMENT '锁定时间',
  `vcStatus` varchar(10) DEFAULT NULL,
  `dtValidTime` timestamp NULL DEFAULT NULL COMMENT '密码有效期',  
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  `dtCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcModifyUser` varchar(20) DEFAULT NULL,
...
CREATE TABLE `tbUserRole` (
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`),
  KEY `FK_REF_ROLE_USER` (`bigRoleId`),
  KEY `FK_REF_USER_ROLE` (`bigUserId`),
  CONSTRAINT `FK_REF_ROLE_USER` FOREIGN KEY (`bigRoleId`) REFERENCES `tbRole` (`bigId`),
  CONSTRAINT `FK_REF_USER_ROLE` FOREIGN KEY (`bigUserId`) REFERENCES `tbUser` (`bigId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 CHECKSUM=1;

/*Data for the table `tbUserRole` */

insert  into `tbUserRole`(`bigId`,`bigRoleId`,`bigUserId`) values (1,1,1);

/*Table structure for table `tbDictionary` */
...
CREATE TABLE `tbDictionary` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bigParentId` bigint(20) DEFAULT NULL,
  `vcKind` varchar(10) DEFAULT NULL COMMENT '1:数值\n            2:字符\n            3:日期',
  `vcName` varchar(200) DEFAULT NULL,
  `vcValue` varchar(200) DEFAULT NULL,
  `isLeaf` tinyint(1) DEFAULT '0',
  `intLevel` int(11) DEFAULT '0',
  `vcOuPath` varchar(1000) DEFAULT NULL COMMENT '如：省公司/市公司/地市公司/部门/工作组/营业厅',
  `vcCreateUser` varchar(20) DEFAULT NULL,
  ...
  `vcRemark` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`bigId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 CHECKSUM=1 COMMENT='每个功能模块都可以有其字典，相当于系统参数\n';

DROP TABLE IF EXISTS `tbDictionaryType`;

CREATE TABLE `tbDictionaryType` (
  `bigId` bigint(20) NOT NULL AUTO_INCREMENT,
  `dtCreateTime` datetime DEFAULT NULL,
  `vcCreateUser` varchar(36) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `dtModifyTime` datetime DEFAULT NULL,
  `vcModifyUser` varchar(36) DEFAULT NULL,
  `version` int(11) DEFAULT NULL,
  `code` varchar(50) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `orderNo` int(11) DEFAULT NULL,
  `groupCode` varchar(50) DEFAULT NULL,
  `vcRemark` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
  KEY `FK8551226D4DC80EF0` (`groupCode`),
  CONSTRAINT `FK8551226D4DC80EF0` FOREIGN KEY (`groupCode`) REFERENCES `tbDictionaryType` (`code`)
...
CREATE TABLE `tbDictionary` (
  ...
  `orderNo` int(11) DEFAULT NULL,
  `vcRemark` varchar(255) DEFAULT NULL,
  `dictionarytypeCode` varchar(50) DEFAULT NULL,
  `parentCode` varchar(50) DEFAULT NULL,
  `value` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
  KEY `FK79C52CB373CC8B3F` (`dictionarytypeCode`),
  KEY `FK79C52CB3BD49F8CB` (`parentCode`),
  CONSTRAINT `FK79C52CB373CC8B3F` FOREIGN KEY (`dictionarytypeCode`) REFERENCES `tbDictionaryType` (`code`),
  CONSTRAINT `FK79C52CB3BD49F8CB` FOREIGN KEY (`parentCode`) REFERENCES `tbDictionary` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

/*Data for the table `tbDictionary` */
