...
<link id="easyuiTheme" rel="stylesheet" href="${ctx}/static/lib/easyui_1.4/themes/<c:out value="${cookie.easyuiThemeName.value}" default="gray"/>/easyui.css"/>
<link rel="stylesheet" type="text/css" href="${ctx}/static/lib/easyui_1.4/themes/default/my97.css"/>
<link rel="stylesheet" type="text/css" href="${ctx}/static/lib/easyui_1.4/themes/icon.css"/>
...
<script type="text/javascript" src="${ctx}/static/lib/easyui_1.4/jquery.min.js"></script>
<script type="text/javascript" src="${ctx}/static/lib/easyui_1.4/jquery.easyui.min.js"></script>
<script type="text/javascript" src="${ctx}/static/lib/easyui_1.4/jquery.cookie.js"></script>
<script type="text/javascript" src="${ctx}/static/lib/easyui_1.4/jquery.my97.js"></script>
